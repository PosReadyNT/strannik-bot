    ...
    async def panel(self, ctx):
        ...
        embed_recovery.add_field(name=':',
                                 value="\n"
                                       ...
                                       "*Спасибо за внимание...*",
                                 inline=False)
        embed_recovery.add_field(name='Выберите реакцию:', value=f'⭕ __**Перезапуск**__\n'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            f'❌ __**Выключение**__\n'
                                                              f'=========2===============\n'
                                                              f'♦ __**Backup**__\n'
                                                              f'========================\n'
        ...
        await msg.add_reaction("♦")
        await msg.add_reaction("💥")
        reaction, user = await self.bot.wait_for("reaction_add",timeout=60.0, check=lambda reaction,user: user.id == ctx.author.id and str(reaction.emoji) in ["⭕","❌","♦","💥", ""] and reaction.message.id == msg.id)
        ...
        if str(reaction.emoji) == "⭕":
            ...
            embed_reload.add_field(name="⭕ __**Перезагрузка**__", value=f"{ctx.author.mention}, начинаю перезапуск. . .")
